...
// // // POST: Save violation with duplicate check
// // app.post('/api/violations', async (req, res) => {
// //   try {
// //     const { imageUrl, label, videoFilename } = req.body;

// //     let noHelmet = 0, phoneUsage = 0, tripling = 0, wrongway = 0;
...
// //     const alreadyExists = await Violation.findOne({ videoFilename, violationType });
// //     if (alreadyExists) {
// //       console.log('⛔ Duplicate violation skipped for:', violationType, videoFilename);
...
// //     console.log('✅ Violation saved:', violationType, videoFilename);
